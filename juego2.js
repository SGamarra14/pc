...
var Juego2 = {
	...
	preload:function () {
		...
		juego.load.audio('ganaste','sounds/soundwin.mp3');
	...
	create:function(){
		...
		txtPuntos=juego.add.text(80,20,"3",{font:"14px Arial",fill:"#FFF"});
		...
		soundwin = juego.sound.add("ganaste");
		soundwin.loop = false;
